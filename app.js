const siteTree = [
  ...
  },
  {
    group: 'Experiments',
    children: [
      { key: 'threejs-typography-site', title: 'Three.js Typography', note: 'Interactive typography concept for Jessica Lea', path: 'sites/threejs-typography-site/index.html?v=20260512n' },
    ],
  },
  {
    group: 'Concepts',
